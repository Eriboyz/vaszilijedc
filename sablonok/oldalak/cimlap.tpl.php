<div class="container">
    <div class="row mb-5">
        <div class="col-lg-8">
            <h2 class="fw-bold mb-4 mt-2">Naplónak indult.</h2>
            <h3 class="fw-bold mb-4">Bemutató bloggá vált.</h3>
    ...
    <div class="row mb-5 mt-5">
        ...
        <div class="col-lg-6">
            ...
            <div class="ratio ratio-16x9 ">
                <iframe src="https://www.youtube.com/embed/a7_WFUlFS94" 
                        title="YouTube video"
